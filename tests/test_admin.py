...
class LogEntryAdminTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.staff_user = User.objects.create_user(
            'staff', 'staff@localhost', 'password', is_staff=True,
        )
    ...
    def test_has_delete_permission(self):
        ...
        with mock.patch(LogEntryAdmin.__module__ + '.DJANGO_ADMIN_LOGS_DELETABLE', False):
            self.request.user = self.admin_user
        ...
        with mock.patch(LogEntryAdmin.__module__ + '.DJANGO_ADMIN_LOGS_DELETABLE', True):
